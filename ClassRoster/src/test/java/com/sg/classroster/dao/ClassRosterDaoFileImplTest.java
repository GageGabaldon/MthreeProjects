...
public class ClassRosterDaoFileImplTest {
    private ClassRosterDao testDao;
...
public void testAddGetStudent() throws Exception {
    ...
    assertEquals("Checking student id.", student.getStudentId(),
                retrievedStudent.getStudentId()
                );
    assertEquals("Checking student first name.", student.getFirstName(),
                retrievedStudent.getFirstName());
    assertEquals(
                "Checking student last name.", student.getLastName(), 
                retrievedStudent.getLastName());
    assertEquals("Checking student cohort.", student.getCohort(), 
